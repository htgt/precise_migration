use utf8;
package Tarmits::Schema::Result::MiPlanStatusStamp;
...
__PACKAGE__->table("mi_plan_status_stamps");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'mi_plan_status_stamps_id_seq'
...
=head2 C<index_one_status_stamp_per_status_and_mi_plan>
...
__PACKAGE__->add_unique_constraint(
  "index_one_status_stamp_per_status_and_mi_plan",
  ["status_id", "mi_plan_id"],
);
