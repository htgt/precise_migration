use utf8;
package Tarmits::Schema::Result::TargRepMutationMethod;
...
=head1 TABLE: C<targ_rep_mutation_methods>

=cut

__PACKAGE__->table("targ_rep_mutation_methods");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'targ_rep_mutation_methods_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4XAmXapbt9cZz9t3YqNutA
...
__PACKAGE__->has_many(
  ...
  { "foreign.mutation_method_id" => "self.id" },
);
