use utf8;
package Tarmits::Schema::Result::TargRepMutationSubtype;
...
=head1 TABLE: C<targ_rep_mutation_subtypes>

=cut

__PACKAGE__->table("targ_rep_mutation_subtypes");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'targ_rep_mutation_subtypes_id_seq'
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:kkfkMxVRuVkDe/02guWotQ
...
__PACKAGE__->has_many(
  ...
  { "foreign.mutation_subtype_id" => "self.id" },
);
