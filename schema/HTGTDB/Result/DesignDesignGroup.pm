use utf8;
package HTGTDB::Result::DesignDesignGroup;
...
=head1 TABLE: C<DESIGN_DESIGN_GROUP>
...
Related object: L<HTGTDB::Result::DesignGroup>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AUnT3A7uXs1RvW0fsrO/ow
