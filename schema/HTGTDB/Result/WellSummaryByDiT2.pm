use utf8;
package HTGTDB::Result::WellSummaryByDiT2;
...
HTGTDB::Result::WellSummaryByDiT2
...
=head1 TABLE: C<WELL_SUMMARY_BY_DI_T2>

=cut

__PACKAGE__->table("WELL_SUMMARY_BY_DI_T2");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yJbTsyrRAQ9hR+PHGXsGfQ
