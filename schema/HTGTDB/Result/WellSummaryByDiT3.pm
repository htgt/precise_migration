use utf8;
package HTGTDB::Result::WellSummaryByDiT3;
...
HTGTDB::Result::WellSummaryByDiT3
...
=head1 TABLE: C<WELL_SUMMARY_BY_DI_T3>

=cut

__PACKAGE__->table("WELL_SUMMARY_BY_DI_T3");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:qNMdC7PtWYbgWibu2RtzgQ
