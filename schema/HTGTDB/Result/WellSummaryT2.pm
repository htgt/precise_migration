use utf8;
package HTGTDB::Result::WellSummaryT2;
...
=head1 TABLE: C<WELL_SUMMARY_T2>

=cut

__PACKAGE__->table("WELL_SUMMARY_T2");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SrsLngFrhDLnfxETfbtMgw
