use utf8;
package HTGTDB::Result::WellSummaryT3;
...
=head1 TABLE: C<WELL_SUMMARY_T3>

=cut

__PACKAGE__->table("WELL_SUMMARY_T3");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PNx4dxjmMlaWeVxZepCypg
